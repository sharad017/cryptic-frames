  ...
  return (
    <div className="absolute bottom-0 left-0 w-full z-[4] px-6 md:px-12 pb-24 md:pb-28 flex flex-col items-start">
      ...
      <p className="hero-line-3 mb-8 md:mb-10"
        style={{ fontFamily: "var(--font-body)", fontSize: "clamp(0.75rem, 1.1vw, 0.88rem)", color: "rgba(232,226,217,0.5)", lineHeight: 1.9, maxWidth: "min(340px, 45vw)", letterSpacing: "0.01em" }}>
      ...
      >
        ...
        <a href="/about"
          ...
          style={{ fontFamily: "var(--font-body)", fontSize: "0.6rem", letterSpacing: "0.22em", color: "rgba(232,226,217,0.5)", whiteSpace: "nowrap" }}>
          About Me →
        </a>
      </div>
